...
class __TwigTemplate_cb5227312043c746ce043898899d5529963924f03ced28c470fa65f2767f9f86 extends Template
{
    private $source;
    private $macros = [];
...
{% else %}
    <a href=\"mailto:{{ field.value }}\">{{ field.formattedValue }}</a>
{% endif %}
", "@EasyAdmin/crud/field/email.html.twig", "/var/www/symfony/vendor/easycorp/easyadmin-bundle/src/Resources/views/crud/field/email.html.twig");
    }
}
